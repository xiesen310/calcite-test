...
public class TutorialReader implements Closeable {
     ...
     */
    public TutorialReader(Reader reader) {
     ...
     */
    public TutorialReader(Reader reader, char separator) {
     ...
     */
    public TutorialReader(Reader reader, char separator, char quotechar) {
     ...
     */
    public TutorialReader(Reader reader, char separator, char quotechar, boolean strictQuotes) {
     ...
     */
    public TutorialReader(Reader reader, char separator, char quotechar, int line) {
     ...
     *            the line number to skip for start reading
     */
    public TutorialReader(Reader reader, char separator, char quotechar, char escape, int line) {
     ...
     *            sets if characters outside the quotes are ignored
     */
    public TutorialReader(Reader reader, char separator, char quotechar, char escape, int line, boolean strictQuotes) {
     ...
     */
    public TutorialReader(Reader reader, char separator, char quotechar, char escape, int line, boolean strictQuotes, boolean ignoreLeadingWhiteSpace) {
